...
import PendingRideRequests from './components/PendingRideRequests/PendingRideRequests';
import CheckRideStatus from './components/CheckRideStatus/CheckRideStatus';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route exact path='/pending-requests' element={token ? <PendingRideRequests /> : <Navigate to="/login" />} />             
        <Route exact path='/check-ride-status' element={token ? <CheckRideStatus /> : <Navigate to="/login" />} />              
